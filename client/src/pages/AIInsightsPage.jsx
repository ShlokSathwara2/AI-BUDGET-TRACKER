...
const AIInsightsPage = ({ transactions = [], user }) => {
        ...
        >
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-400 mt-1">Smart spending alerts and behavioral analysis</p>
            </div>
          </div>

          {/* AI Insights Component */}
          <SmartOverspendingAlerts transactions={transactions} user={user} />
        </motion.main>
      </div>
    </div>
  );
